...
type Party struct {
	...
	CreditOverdraftDays int             `json:"credit_overdraft_days" db:"credit_overdraft_days"`
	LastCreditCheckAt   *time.Time      `json:"last_credit_check_at,omitempty" db:"last_credit_check_at"`
